...
<form method="post" action="loginaction.php">
  <table border="0">
    <tr><td><input type="text" name="username" placeholder="username..." size="40" maxlength="30"></tr></td>
    <tr><td><input type="password" name="pass" placeholder="password..." size="40" maxlength="30"></tr></td>
    <tr>
      <td>&nbsp;</td>
